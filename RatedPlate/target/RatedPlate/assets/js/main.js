...
function testAPI() {
    ...
    FB.api('/me', function(response) {
        ...
        //window.location.replace ("googleTest.html");

        document.getElementById('status').innerHTML =
            'Thanks for logging in, ' + response.name + '!';

        alert('How sick is this shit?! ' +
            '\nYour details: ' +
            '\nName: ' + response.name +
            '\nID: ' + response.id +
...
//Need a way for dynamicially loading this, so the image is associatee with somthing that is pulled from the map.
function init_gmap3(){
    $(function(){
...

                        {
                            overlay:{
                                ...
                                options:{
                                    ...
                                    "</h4>"+
                                    "<img src='"+ context.data.img_preview +"' width=90> $300.999 FUCKYOU <br/>"+
