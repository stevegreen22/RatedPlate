...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <c:out value="${stringList}" />

            <jsp:include page="includes/breadcrumbs.jsp"/>
...
<!--                        <img src="assets/images/agents/n5.png" alt="ceo"/> maybe have a restaurant or plate of food here-->
                ...
                <jsp:include page="includes/headerCarousel.jsp"/>

                <div class="container">
                    <div class="row-fluid">
                        <div class="span9">
                            <div class="panel right-line">
                                <jsp:include page="includes/featuredGrid.jsp"/>
                            </div>

                            <jsp:include page="includes/plateNews.jsp"/>
                        </div>
                    </div>
                        <div class="span3">
                            <div class="panel">
